    ...
    public class ArticleController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Article != null ? 
                          ...
                          Problem("Entity set 'ArticleContext.Article'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Description,Price,Stock,Category")] Article article)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Description,Price,Stock,Category")] Article article)
        {
            if (id != article.Id)
            {
                return NotFound();
